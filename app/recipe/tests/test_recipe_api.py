...
def sample_recipe(user, **params):
    """Create amd retirm a sample recipe"""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        ...
        user2 = get_user_model().objects.create_user("pepo@pepo", "passpeppo")
    ...
    def test_create_recipe_with_ingredients(self):
        """Test creting recipe with ingredients"""
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        """Test uploading and email to recipe"""
    ...
    def test_upoload_image_bad_request(self):
